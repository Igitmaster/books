    ...
    public static void main(String[] args) {
        ...
        while(true) {
            ...
            switch (num) {
                ...
                case 7: bookService.removeAuthor(scan.nextInt());break;
                case 8: bookService.removeBook(scan.nextInt());break;
                case 9: bookService.updateBook();break;
                case 10:bookService.updateAuthor();break;

...
public class BookDAO {
    ...
    private void createTable() {
        try {
            ...
            st.execute("create table if not exists BOOK(id integer auto_increment primary key, " +
    ...
    public void add(Book book)
    {
        try {
           Statement st = connection.createStatement();
            st.execute("INSERT INTO BOOK VALUES(default,'"+book.getTitle()+"',"+book.getYear()+","+book.getIdAuthor()+")");
        } catch (SQLException ex) {
            ex.printStackTrace();
